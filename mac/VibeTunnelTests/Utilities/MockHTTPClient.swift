...
final class MockHTTPClient: HTTPClientProtocol {
    ...
    func configureJSON(_ object: some Encodable, statusCode: HTTPResponse.Status = .ok, for path: String) throws {
...
extension MockHTTPClient.ResponseConfig {
    ...
    static func json(_ object: some Encodable, statusCode: HTTPResponse.Status = .ok) throws -> MockHTTPClient
        .ResponseConfig
    {
        let encoder = JSONEncoder()
        encoder.dateEncodingStrategy = .iso8601
